...
public class Logger : MonoBehaviour {
    ...
    void Update () 
	{
		...
		if(writer != null)
		{
            ...
            else if(DonkeyStyle2)
            {
                ...
                {
                    mjson.Init(
                        string.Format("{0}_cam-image_array_.png", frameCounter),
                        steering,
                        throttle,
                        "user",
                        0,
	...
	{
		return GetLogPath() + string.Format("IMG/center_{0,8:D8}.png", frameCounter);
    }

    string GetDonkey2StyleImageFilename()
    {
        return GetLogPath() + string.Format("{0}_cam-image_array_.png", frameCounter);
    }
